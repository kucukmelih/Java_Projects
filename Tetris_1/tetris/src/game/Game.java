...
//****************** buraya ekledik gameover'ı
	...
	private void tick() {
		...
		if (this.field.isPieceFallen(currentPiece)) {
			// Eğer aktif parça en üst sıraya değdiyse
			if (field.doesPieceTouchesTopControl(currentPiece)) {
				// Oyunu durdur ve "Game Over" mesajını göster
